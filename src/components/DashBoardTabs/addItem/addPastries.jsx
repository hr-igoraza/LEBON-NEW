...
const AddPastryItem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await API.post("/pastries/add", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });

      setMessage("Item added to Pastries successfully!");
      setMessageType("success");
      setLoading(false);
      setItemName("");
      setDescription("");
      setPrice("");
      setCategory("pastries"); // Reset category to "pastries"
  ...
  return (
    <div className="container">
      <div className="text-white">
        <h2>Add Pastry Item</h2>
        <p>Here you can add a new item to the Pastries category.</p>
